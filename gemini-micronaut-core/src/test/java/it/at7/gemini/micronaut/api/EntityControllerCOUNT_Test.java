...
public class EntityControllerCOUNT_Test {
    ...
    @Test
    void checkCount() {
        HttpResponse<GeminiHttpResponse> resp = client.toBlocking().exchange(HttpRequest.GET("/basetypes/recordCounts"), GeminiHttpResponse.class);
        ...
        Map<String, Object> data = (Map<String, Object>) gr.getData();
        Assertions.assertTrue(data.containsKey("count"));
