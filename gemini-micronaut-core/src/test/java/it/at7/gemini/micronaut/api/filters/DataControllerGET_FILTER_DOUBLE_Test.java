...
class DataControllerGET_FILTER_DOUBLE_Test {
    ...
    @Test
    void filterEqual() {
        String filter = "filterString=" + randomUUID + "&doubleField=10.1";
    ...
    @Test
    void filterNotEqual() {
        String filter = "filterString=" + randomUUID + "&doubleField[NOT_EQUALS]=10.1";
        HttpResponse<GeminiHttpResponse> resp = client.toBlocking().exchange(HttpRequest.GET("/basetypes?" + filter), GeminiHttpResponse.class);
        Assertions.assertEquals(resp.getStatus(), HttpStatus.OK);
        Optional<GeminiHttpResponse> body = resp.getBody();
        Assertions.assertTrue(body.isPresent());
        ...
        filter = "filterString=" + randomUUID + "&doubleField[!]=10.1";
        ...
        filter = "filterString=" + randomUUID + "&doubleField[NOT]=10.1";
        resp = client.toBlocking().exchange(HttpRequest.GET("/basetypes?" + filter), GeminiHttpResponse.class);
        Assertions.assertEquals(resp.getStatus(), HttpStatus.OK);
        body = resp.getBody();
        Assertions.assertTrue(body.isPresent());
    ...
    @Test
    void filterGT() {
        String filter = "filterString=" + randomUUID + "&doubleField[GT]=10.1";
        HttpResponse<GeminiHttpResponse> resp = client.toBlocking().exchange(HttpRequest.GET("/basetypes?" + filter), GeminiHttpResponse.class);
        Assertions.assertEquals(resp.getStatus(), HttpStatus.OK);
        Optional<GeminiHttpResponse> body = resp.getBody();
        Assertions.assertTrue(body.isPresent());
        ...
        filter = "filterString=" + randomUUID + "&doubleField[GTE]=10.1";
        resp = client.toBlocking().exchange(HttpRequest.GET("/basetypes?" + filter), GeminiHttpResponse.class);
        Assertions.assertEquals(resp.getStatus(), HttpStatus.OK);
        body = resp.getBody();
        Assertions.assertTrue(body.isPresent());
    ...
    @Test
    void filterLT() {
        String filter = "filterString=" + randomUUID + "&doubleField[LT]=10.1";
        HttpResponse<GeminiHttpResponse> resp = client.toBlocking().exchange(HttpRequest.GET("/basetypes?" + filter), GeminiHttpResponse.class);
        Assertions.assertEquals(resp.getStatus(), HttpStatus.OK);
        Optional<GeminiHttpResponse> body = resp.getBody();
        Assertions.assertTrue(body.isPresent());
        ...
        filter = "filterString=" + randomUUID + "&doubleField[LTE]=10.1";
        resp = client.toBlocking().exchange(HttpRequest.GET("/basetypes?" + filter), GeminiHttpResponse.class);
        Assertions.assertEquals(resp.getStatus(), HttpStatus.OK);
        body = resp.getBody();
        Assertions.assertTrue(body.isPresent());
    ...
    @Test
    void filterLTGT() {
        String filter = "filterString=" + randomUUID + "&doubleField[GT]=10.1&doubleField[LT]=30.1";
        HttpResponse<GeminiHttpResponse> resp = client.toBlocking().exchange(HttpRequest.GET("/basetypes?" + filter), GeminiHttpResponse.class);
        Assertions.assertEquals(resp.getStatus(), HttpStatus.OK);
        Optional<GeminiHttpResponse> body = resp.getBody();
        Assertions.assertTrue(body.isPresent());
        ...
        filter = "filterString=" + randomUUID + "&doubleField[GTE]=10.1&doubleField[LTE]=30.1";
        resp = client.toBlocking().exchange(HttpRequest.GET("/basetypes?" + filter), GeminiHttpResponse.class);
        Assertions.assertEquals(resp.getStatus(), HttpStatus.OK);
        body = resp.getBody();
        Assertions.assertTrue(body.isPresent());
